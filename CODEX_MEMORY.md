...
- `AGENTS.md` definiert seit 2026-04-21 ein festes Agententeam fuer nicht-triviale Arbeit. Seit 2026-04-22 haben alle Rollen kurze Rufnamen fuer direkte Ansprache: `Atlas` (Lead), `Nova` (Product & UX), `Flux` (Frontend), `Forge` (Backend & AI), `Orbit` (Platform & Release), `Shield` (Security & Privacy), `Probe` (QA & E2E), `Gate` (Review Gate), `Quill` (Docs & Ops), `Pulse` (Data & Admin Insights).
